...
**Description**: Repository for revolut-ticker-agent - [Brief description to be added]
...
|-----------|-----------------|
| Bug Report | Open a [GitHub Issue](https://github.com/Stijnman/revolut-ticker-agent/issues) |
| Security Issue | Email: security@stijnman.com |
| General Question | Open a [GitHub Discussion](https://github.com/Stijnman/revolut-ticker-agent/discussions) |
